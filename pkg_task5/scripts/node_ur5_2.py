            ...
            if (pkg != "ur5") and (
                ...
                if (y <= 0.166258826852) and (y <= 0.000000001):
                    ...
                    if (
                        ...
                        self.conveyor(100)
                        if color == "red":
                            self.hard_set_joint_angles(red_bin_pose, 5)

                        elif color == "yellow":
                            self.hard_set_joint_angles(yellow_bin_pose, 5)

                        elif color == "green":
                            self.hard_set_joint_angles(green_bin_pose, 5)
                        self.vacuum(False)
                        ...
                        delivery_time = (
                            lambda time_now, color: time_now
                            + dt.timedelta(days=1)
                            if color == "red"
                            else (
                        ...
                        rospy.set_param(
                            "packages/{}".format(pkg), pkg_details_dic
                        )
                        ...
                        parameters = {
                            ...
                            "Order Date and Time": pkg_details_dic[
                                "order_time"
                            ],
                        ...
                        self.hard_set_joint_angles(
                            self._home_pose_joint_angles, 5
                        )
